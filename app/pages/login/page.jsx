            ...
            {showOverlay && (
                <div className="absolute inset-0 z-20 flex items-center justify-center backdrop-blur-sm bg-black/30">
                    <div className="rounded-xl bg-white px-6 py-4 text-lg font-semibold text-gray-700 shadow-lg">
                        {loadingMessage}
                        <div className="mt-2 h-5 w-5 animate-spin rounded-full border-2 border-blue-100 border-t-transparent" />
                    </div>
                </div>
            )}

            <div className={`w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl z-10 transition ${showOverlay ? 'blur-sm pointer-events-none' : ''}`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        className="w-full rounded-lg bg-blue-200 px-4 py-2 font-bold text-black hover:bg-blue-400 transition"
                    >
                        Sign In
                    </button>
                </form>
                ...
                <p className="mt-6 text-center text-sm text-gray-500">
                    ...
                    <Link href="/pages/register" className="font-semibold text-blue-500 hover:underline">
                        Register
                    </Link>
                </p>
            </div>
